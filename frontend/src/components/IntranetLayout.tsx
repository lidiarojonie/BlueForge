                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        `flex items-center gap-2 px-3 lg:px-5 py-2.5 rounded-xl transition-all group font-bold text-xs lg:text-sm uppercase tracking-widest whitespace-nowrap ${isActive
